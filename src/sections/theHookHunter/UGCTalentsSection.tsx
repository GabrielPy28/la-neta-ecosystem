...
const TALENTS = [
  {
    ...
    categoryEn: 'Fashion',
    media: 'image',
    src: 'https://la-neta-videos-ubicacion.s3.us-east-1.amazonaws.com/Maya_Influencer_Moda.jpg',
    accent: '#f59e0b',
  ...
  },
  {
    ...
    media: 'image',
    src: 'https://la-neta-videos-ubicacion.s3.us-east-1.amazonaws.com/Victoria_Influencer_Food.jpg',
    accent: '#10b981',
  ...
  },
  {
    ...
    categoryEn: 'Geek',
    media: 'image',
    src: 'https://la-neta-videos-ubicacion.s3.us-east-1.amazonaws.com/jezael_influencer_geek.jpg',
    accent: '#8b5cf6',
  ...
  },
  {
    ...
    media: 'image',
    src: 'https://la-neta-videos-ubicacion.s3.us-east-1.amazonaws.com/flip_influencer_lifestyle.jpg',
    accent: '#ec4899',
