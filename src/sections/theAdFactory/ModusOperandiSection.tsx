...
export function ModusOperandiSection() {
  return (
    ...
    >
      {/* One bold card container — light theme to match page */}
      <div className="relative overflow-hidden rounded-3xl border border-slate-200/80 bg-white/95 shadow-xl ring-1 ring-slate-200/80 backdrop-blur-sm">
        ...
        {/* Ambient glows behind each step — subtle on light */}
              ...
              >
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background: `radial-gradient(circle at 30% 30%, ${step.accent}40, ${step.accent}18)`,
                      boxShadow: `0 0 0 2px ${step.accent}40, 0 16px 48px -12px ${step.accent}35`,
                    }}
                    aria-hidden
                  >
                    <Icon
        ...
        <div className="relative border-t border-slate-200 px-6 py-5 text-center md:px-12">
          <p className="text-sm font-semibold text-slate-600 md:text-base">
            Same pipeline. No handoffs. <span className="text-[var(--laneta-purple)]">From brief to feed.</span>
          </p>
        </div>
      </div>
    </motion.section>
